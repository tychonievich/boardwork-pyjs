...
> [!NOTE]
> I find that running this under X11 (with any browser) it lags noticeably, but under Wayland it does not. I do not use, and cannot speak to the efficiency of, the display protocols bundled in operating systems created by Microsoft, Apple, and Google.
